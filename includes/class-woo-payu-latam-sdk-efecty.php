...
class WC_Payment_Payu_Latam_SDK_Efecty_PLSE extends WC_Payment_Gateway
{
    public function __construct()
    {
        $this->id = 'payu_latam_sdk_efecty_plse';
        $this->icon = woo_payu_latam_sdk_pls()->plugin_url . 'assets/images/efecty.jpg';
        $this->method_title = __('Efecty', 'woo-payu-latam-sdk');
    ...
    public function init_form_fields()
    {
        ...
        $this->form_fields = [
            'enabled' => [
                ...
                'type' => 'checkbox',
                'label' => __('Enable Efecty', 'woo-payu-latam-sdk'),
                'default' => 'no'
            ],
            'title' => [
                ...
                'default' => __('Efecty', 'woo-payu-latam-sdk'),
                'desc_tip' => true
            ],
            'description' => [
    ...
    public function process_payment($order_id)
    {
        ...
        $params['payu-latam-sdk-payment-method'] = 'EFECTY';
